...
As you'll recall from my article [[./What's so bad about batting average? (Sabermetrics 101: Basic Hitting Stats — Part 1)|on OBP]], OBP has an r-squared of 0.704 against runs scored. OPS, in Figure 1, has an r-squared of 0.878. Even visually you can recognize how closely OPS corresponds with run scoring. OPS is incredibly good at predicting the number of runs a team will score over a season because it encompasses and accounts for all outcomes.
