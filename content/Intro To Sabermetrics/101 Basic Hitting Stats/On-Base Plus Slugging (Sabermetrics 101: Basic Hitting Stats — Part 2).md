...
![[/content/00 internal files/Assets/ops_vs_runs.png|ops_vs_runs.png]]
**Figure 1. Team OPS vs Runs Scored, 1990-2024, excl. 1994, 2020**

As you'll recall from my article [[/content/Intro To Sabermetrics/101 Basic Hitting Stats/What's so bad about batting average? (Sabermetrics 101: Basic Hitting Stats — Part 1)|on OBP]], OBP has an R-squared of 0.704 against runs scored. OPS, in Figure 1, has an R-squared of 0.899. Even visually you can recognize how closely OPS corresponds with run scoring. OPS is incredibly good at predicting the number of runs a team will score over a season because it encompasses and accounts for all outcomes.
